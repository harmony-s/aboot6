...
REPLACE INTO `sys_menu` (`id`, `name`, `authorities`, `i_frame`, `enabled`, `cache`, `component`, `parent_id`, `sort`, `icon`, `path`, `created_at`, `created_by`, `deleted_at`, `updated_at`, `updated_by`) VALUES (17, '个人中心', NULL, b'0', b'0', b'0', '/person/index', 0, 1, '个人中心', '/home/person', '2019-08-03 11:29:17', 0, NULL, '2022-02-28 16:25:46', NULL);
