...
(
  ...
  AUTO_INCREMENT = 1
  COLLATE = utf8mb4_general_ci COMMENT = '字典详情';
...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '角色拥有菜单';
...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '角色拥有权限';
...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '用户拥有角色';
...
(
  ...
  AUTO_INCREMENT = 1
  COLLATE = utf8mb4_general_ci COMMENT = '访问记录';
...
(
  ...
  AUTO_INCREMENT = 1
  COLLATE = utf8mb4_general_ci COMMENT = '前端配置';
...
(
  ...
  AUTO_INCREMENT = 1
  COLLATE = utf8mb4_general_ci COMMENT = '存储';
...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '数据组';
